...
var $pack_0='';
var $pack_1=array('conecto_datos','conecto_stats','documento', 'foro');
...
'documento'=>array('idioma', 'otro_idioma','seccion','subseccion','traducir','url', 'archivo', 'html', 'conecto_datos','conecto_stats', 'bgcolor_gestion', 'f_color_gestion'),
...
'upload'=>array('idioma','documento', 'seccion', 'archivo', 'user', 'password'),
'foro'=>array('idioma', 'otro_idioma','seccion','subseccion','url', 'archivo', 'html', 'traducir','datos', 'bgcolor_gestion', 'f_color_gestion', 'Link_ID'),
...
$array_traducciones_directas=array('descarga_doc');
if(is_array($array_traducciones_directas)){
 $this->traducir=$array_traducciones_directas;
 }
...
$arra_pack_1=array('index.php', 'red.php','presenta.php', 'info.php', 'equipos.php', 'foros.php','message.php', 'agenda.php', 'socios.php', 'contacto.php');
