...
function mail(){
$info.=$this->documento->abrir_tabla_modulo('100%', 50,"left");//($ancho,$alto, $alinear_tabla="left")
$info.=$this->documento->abrir_tabla_info('100%', 50,"left","middle");//($ancho,$alto,$alinear_central_h, $alinear_central_v)
...
$contenido=$this->documento->a_html($_POST["contenido"]);
...
$asunto= $this->documento->a_html($_POST["asunto"]);
#$asunto=ereg_replace("[\n]","<br>",$asunto);
$contenido1= $this->documento->a_html($_POST["contenido"]);
...
\n\n -->\n<HTML>\n
<HEAD>\n
<TITLE>Turismo de la Provincia de Sevilla</TITLE>\n
...
<TR><TD><IMG SRC='http://www.meetingsevilla.org/00_gestion/10_mail/images/logo.gif' WIDTH=528 HEIGHT=100 ALT=''></TD></TR>\n
...
$info.="</form>";
$info.="\n</td></tr></table>";
$info.=$this->documento->cerrar_tabla_info('100%', 50,"left","middle");//($ancho,$alto,$alinear_central_h, $alinear_central_v)
$info.=$this->documento->cerrar_tabla_modulo('100%', 50);
return $info;
}//function mail
