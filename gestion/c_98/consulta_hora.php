<?php
require("sqls_horario.php");
$titulo_grafico="Estadisticas en $usuario_nombre. Grafico horario. Intervalo ($fecha_1/$fecha_2)";
$objeto->conecto_datos->query($query_horario);
$p=0;
$limite_p=24;
$c=1;
while($objeto->conecto_datos->next_record()){
        ...
        if($c===1 && !$fin_time) $time_line[]=$objeto->conecto_datos->Record['hora'];
