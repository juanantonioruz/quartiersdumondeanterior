...
array("select * from dato_sql_select where  id_dato_sql_select='".$_POST['id_dato_sql_select']."'  and dato_sql_select='".$_POST['dato_sql_select']."' and dato_sql_select_tipo='".$_POST['dato_sql_select_tipo']."'  and id_dato_sql_select <>".$_POST['id_dato_sql_select'], "mensaje de alarma1" , "update dato_sql_select  set [*] where id_dato_sql_select =".$_POST['id_dato_sql_select'])
);
