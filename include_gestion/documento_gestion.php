...
$salida.= "<table class='modulo'  width='$ancho' height='$alto' border='1' cellspacing='0' cellpadding='0' align='$alinear_tabla'>\n";
$salida.= "<tr>\n";
...
$salida.= "<table border='1' cellspacing='1' cellpadding='5' width='100%' bgcolor='".$this->bgcolor_gestion."' BORDERCOLOR='red'><tr class='bg_color_2'><td align='left'>\n";
return $salida;
}//function
...
$salida.= "<!--[if gte IE 5.5000]>
<script type='text/javascript' src='".$this->url."../../css/pngfix.js'></script>
<![endif]-->\n";
...
$salida.= $this->modulo("<table border='0' cellspacing='1' cellpadding='5' width='300' bgcolor='".$this->bgcolor_gestion."' >
<tr class='bg_color_4'><td align='right'><font color='".$this->f_color_gestion."'><b>Zona de gesti&oacute;n </b></font></td></tr><form action='".$_SERVER['PHP_SELF']."' method='post' >
<tr class='bg_color_3'><td align='right'><font color='".$this->f_color_gestion."'>usuario  </font><input type='text' name='user' value=''></td></tr>
<tr class='bg_color_1'><td align='right'><font color='".$this->f_color_gestion."'>clave </font><input type='password' name='password' value=''></td></tr>
<tr class='bg_color_3'><td align='center'><input type='submit' name='enviar_claves' value='enviar'></td></tr>
</form>
</table>");
$salida.=  "</td></tr></table>";
return $salida;
...
if(!$padding) $padding="padding:1px"; else $padding="padding:".$padding."px";
$base_imagen='mod';
return  "<div align='$centrado'>
<table id='Table_01'   border='0' cellpadding='0' cellspacing='0'>
	<tr>
		<td>
			<img src='../c_99/images_gestion/".$base_imagen."_01.gif' width='13' height='13' alt=''></td>
		<td style='background: url(../c_99/images_gestion/".$base_imagen."_02.gif) repeat-x ;'>
			<img src='../c_99/images_gestion/ajuste.gif'  height='13' alt=''></td>
		<td>
			<img src='../c_99/images_gestion/".$base_imagen."_03.gif' width='14' height='13' alt=''></td>
	</tr>
	<tr>
		<td style='background: url(../c_99/images_gestion/".$base_imagen."_04.gif) repeat-y ;'>
			<img src='../c_99/images_gestion/ajuste.gif' width='13' height='5' alt=''></td>
		<td style='background:url(../c_99/images_gestion/".$base_imagen."_05.gif); $padding' align='center'>
		$info
		</td>
		<td style='background: url(../c_99/images_gestion/".$base_imagen."_06.gif) repeat-y ;'>
			<img src='../c_99/images_gestion/ajuste.gif' width='14' height='5' alt=''>
                        </td>
	</tr>

	<tr>
		<td>
			<img src='../c_99/images_gestion/".$base_imagen."_07.gif' width='13' height='13' alt=''></td>
		<td style='background: url(../c_99/images_gestion/".$base_imagen."_08.gif) repeat-x ;'>
			<img src='../c_99/images_gestion/ajuste.gif'  height='13' alt=''></td>
		<td>
			<img src='../c_99/images_gestion/".$base_imagen."_09.gif' width='14' height='13' alt=''></td>
	</tr>
</table>
</div>";
