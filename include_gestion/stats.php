...
$this->Host="localhost";
$this->User="root3";
$this->Password="nickel3";
$this->Database="meetingsevilla";

  $this->Host="llda252.servidoresdns.net";
   $this->User="qx280";
   $this->Password="stats_new";
   $this->Database="qx280";
...
#echo $country_query;
   ...
   $this->Database="coordinadora";
     $this->Host="llda252.servidoresdns.net";
   $this->User="qaa121";
   $this->Password="coordinadora";
   $this->Database="qaa121";
